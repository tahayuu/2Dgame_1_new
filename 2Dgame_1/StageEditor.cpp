...
static const TypeParamInfo TYPE_PARAMS[(int)EditorObjectType::COUNT] = {//•	新しいオブジェクトを追加しても、COUNT が自動で増える
    /* 0  PLATFORM              */ { 0, {} },
    /* 1  BACK_PLATFORM         */ { 0, {} },
    /* 2  HAZARD                */ { 2, {{"disableSnapGroupId",0,false},{"disableDistanceTriggerId",0,false}} },
    ...
    /* 56 EVENT_CHANGER */{6,{{"targetEventId", 1, false},{"changedSpriteId", 0, false},{"jumpMode(0:normal -1:N)", 1, false},{"restoreOnExit", 1, true},{"oneShot", 0, true},{"inputSignalId",0,false}}},
    ...
    /* 59 DISTANCE_TRIGGER_PIECE */ {4, { {"outputSignalId", 1, false}, {"detachDistance", 80, false}, {"reattachDistance", 30, false},  {"returnOnRelease", 0, true}  }},
};
...
static const char* const EN_NAMES[(int)EditorObjectType::COUNT] = {
    ...
    "decorSprites","movePlatformYXY","eventChangers","dragPieces","snapSlots","distanceTriggerPieces"
};
...
static const char8_t* const JP_NAMES_U8[(int)EditorObjectType::COUNT] = {
  ...
  u8"一時床スイッチ",u8"矢印",u8"装飾",u8"Ｙ→Ｘ→Ｙ移動床",u8"イベント変更エリア",u8"ドラッグピース",u8"スナップスロット",u8"距離トリガーピース"
};
...
{255, 180, 100, 220}, // 59 DistanceTriggerPiece
};
