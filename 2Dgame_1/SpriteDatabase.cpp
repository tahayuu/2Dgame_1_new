...
namespace {
    ...
    const SpriteEntry g_spriteTable[] = {
        ...
        { SpriteId::PipeStraight,  "PipeStraight",  "assets/images/stage/stage_3/pipe_straight.png" },
        { SpriteId::PipeCorner,    "PipeCorner",    "assets/images/stage/stage_3/pipe_corner.png" },
